...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-20 px-6 md:px-12 bg-[#0d0d0d]">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-8 text-center font-mono text-sm text-gray-500">
          <p>Or reach out directly at <a href="mailto:ronak@example.com" className="text-cyan-400 hover:underline">ronak@example.com</a></p>
        </div>
      </div>
    </section>
  );
