...
export default function Navigation() {
  ...
  return (
    <>
      <nav className="site-nav fixed top-0 left-0 right-0 z-50" style={navStyle}>
          ...
          {menuLinks.map((link, index) => (
            <a
              key={link.href}
                ...
                className="block px-4 py-3 text-gray-300 hover:text-cyan-400 hover:bg-[#252525] rounded-lg transition-all duration-200 opacity-100 translate-x-0"
