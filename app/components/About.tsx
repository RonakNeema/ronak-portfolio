            ...
            <div className="grid md:grid-cols-12 gap-8">
              ...
              <div className="md:col-span-8">
                ...
                <div className="space-y-4 text-gray-300 leading-relaxed font-mono text-sm">
                  ...
                  <p>
                    <span className="text-gray-500">{'>'}</span> Recently completed my <span className="text-green-400">Master&apos;s in Computer Science</span> at University of Colorado, Denver (May 2025), while working full-time as a DevOps Engineer at Can/Am Technologies.
                  </p>
                  <p>
                  ...
                  <p>
                    <span className="text-gray-500">{'>'}</span> When I&apos;m not coding, I&apos;m exploring new technologies, playing music, sketching, or turning <span className="text-green-400">coffee</span> into <span className="text-cyan-400">code</span>. ☕
                  </p>
                </div>
